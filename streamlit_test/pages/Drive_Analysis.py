...
def display1(data, possessions_df, selections):
    ...
    with col1:
        ...
        if show_drives:
            ...
            min_num_drives = st.slider('Minimum Numer of Drives in the Possession', min_value=1, max_value=max(possessions_df['# Drives'].values))
            ...
            min_def_passed = st.slider('Minimum # of Defenders the Ball Passed', min_value=0, max_value=5)
...
def display3(data, original_data):
    ...
    with col2:
        ...
        fig2.update_layout(width=600, height=400,  
                        title='Points Per Possession', title_x=0.3,
                        xaxis_title="Minimum Drive Distance", legend_title=None) 
...
def display4(data):    
    ...
    min_num_drives = st.slider('Minimum Number of Transition Drives Per Game')
...
def main():
    ...
    display1(drive_data, possessions_df, selections)
